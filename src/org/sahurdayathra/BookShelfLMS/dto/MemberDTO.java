...
public class MemberDTO {
    ...
    public MemberDTO(String libRegNO, String admissionNO, String name, String address_no, String address_street, String address_village, String address_city, String contactNO, String otherDetails) {
    ...
    public String toString() {
        return "StudentDTO{" + "libRegNO=" + libRegNO + ", admissionNO=" + admissionNO + ", name=" + name + ", address_no=" + address_no + ", address_street=" + address_street + ", address_village=" + address_village + ", address_city=" + address_city + ", contactNO=" + contactNO + ", otherDetails=" + otherDetails + '}';
    }
