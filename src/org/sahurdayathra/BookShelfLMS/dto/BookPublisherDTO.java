...
public class BookPublisherDTO {
    ...
    public BookPublisherDTO(String bookPublisherID, String name, String address_no, String address_street, String address_village, String address_city, String email, String contactNO, String otherDetails) {
    ...
    public String toString() {
        return "BookPublisherDTO{" + "bookPublisherID=" + bookPublisherID + ", name=" + name + ", address_no=" + address_no + ", address_street=" + address_street + ", address_village=" + address_village + ", address_city=" + address_city + ", email=" + email + ", contactNO=" + contactNO + ", otherDetails=" + otherDetails + '}';
    }
